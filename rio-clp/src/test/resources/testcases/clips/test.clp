#
# Test file for own CLIPS format based on N-Triples one [1].
#
# (not sure whether the copyright must be retained just because I use the same triples, but JIC...)
#
...
#
#
# [1] https://bitbucket.org/openrdf/sesame/src/master/testsuites/rio/src/main/resources/testcases/ntriples/test.nt?at=master
# 
#####################################################################
